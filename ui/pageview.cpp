...
//  See http://stackoverflow.com/questions/19199863/draw-rectangular-overlay-on-qwidget-at-click
                ...
                else if ( choice == tagSelection )
                {
                    ...
                    for ( ; iIt < iEnd; ++iIt )
                    {
                        ...
                        if (! intersect.isNull( ) )
                        {
                            ...
                            QWidget * parent = d->q->viewport();
                            QWidget * overlay = new Overlay ( parent );
                            overlay->setGeometry(intersect);
                            overlay->show();
#####
